...
*/}}
{{- define "rancher-operator.fullname" -}}
...
*/}}
{{- define "rancher-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "rancher-operator.resourceName" -}}
{{- $fullname := include "rancher-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
*/}}
{{- define "rancher-operator.serviceAccountName" -}}
{{- if and (not (.Values.serviceAccount.enabled | default true)) .Values.serviceAccount.name }}
{{- .Values.serviceAccount.name }}
{{- else }}
{{- include "rancher-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
